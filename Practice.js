...
var almonds = Object.create(nuts);
almonds.shape = "terdrop";
almonds.favNutType = function(){
    return 'The ' + this.type + ' looks like a ' + this.color + " "+ this.shape + '.';
};
var peeledAlmond = Object.create(almonds);
peeledAlmond.type = "peeled almond";
peeledAlmond.color = "white";
console.log(peeledAlmond.sayHello());
console.log(peeledAlmond.favNutType());
